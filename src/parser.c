...
enum ts_symbol_identifiers {
  ...
  sym_raw_verbatim = 47,
  sym_raw_string = 48,
  anon_sym_DOLLAR_DQUOTE = 49,
  anon_sym_DQUOTE = 50,
  sym_interp_text = 51,
  sym_interp_escape = 52,
  sym_interp_hole = 53,
  sym_splat = 54,
  sym_sigil = 55,
  sym_splice = 56,
  ...
  anon_sym_CARET = 81,
  anon_sym_DOT = 82,
  anon_sym_LBRACE_PIPE = 83,
  anon_sym_PIPE_RBRACE = 84,
  anon_sym_LPAREN = 85,
  anon_sym_RPAREN = 86,
  anon_sym_LBRACK = 87,
  anon_sym_RBRACK = 88,
  ...
  sym_heredoc_text = 102,
  sym_heredoc_hole = 103,
  sym__district_end = 104,
  sym_source_file = 105,
  sym__item = 106,
  sym_let_head = 107,
  sym_type_head = 108,
  ...
  sym_keyword = 111,
  sym_boolean = 112,
  sym_interp_string = 113,
  sym_operator = 114,
  sym_punctuation = 115,
  aux_sym_source_file_repeat1 = 116,
  aux_sym_interp_string_repeat1 = 117,
};
