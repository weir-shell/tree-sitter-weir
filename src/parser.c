...
enum ts_symbol_identifiers {
  ...
  sym_raw_verbatim = 45,
  sym_raw_string = 46,
  anon_sym_DOLLAR_DQUOTE = 47,
  anon_sym_DQUOTE = 48,
  sym_interp_text = 49,
  sym_interp_escape = 50,
  sym_interp_hole = 51,
  sym_splat = 52,
  sym_sigil = 53,
  sym_splice = 54,
  ...
  anon_sym_CARET = 79,
  anon_sym_DOT = 80,
  anon_sym_LBRACE_PIPE = 81,
  anon_sym_PIPE_RBRACE = 82,
  anon_sym_LPAREN = 83,
  anon_sym_RPAREN = 84,
  anon_sym_LBRACK = 85,
  anon_sym_RBRACK = 86,
  ...
  sym_yaml_for = 97,
  sym_yaml_hole = 98,
  sym_heredoc_marker = 99,
  sym_heredoc_text = 100,
  sym_heredoc_hole = 101,
  sym__district_end = 102,
  sym_source_file = 103,
  sym__item = 104,
  sym_let_head = 105,
  sym_type_head = 106,
  ...
  sym_keyword = 109,
  sym_boolean = 110,
  sym_interp_string = 111,
  sym_operator = 112,
  sym_punctuation = 113,
  aux_sym_source_file_repeat1 = 114,
  aux_sym_interp_string_repeat1 = 115,
};
